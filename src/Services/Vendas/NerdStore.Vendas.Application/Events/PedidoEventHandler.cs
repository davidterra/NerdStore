...
namespace NerdStore.Vendas.Application.Events
{
        ...
        INotificationHandler<PagamentoRecusadoEvent>
    {
        ...
        public Task Handle(PedidoAtualizadoEvent notification, CancellationToken cancellationToken) => Task.CompletedTask;
        ...
        public async Task Handle(PagamentoRecusadoEvent message, CancellationToken cancellationToken) => await _mediatorHandler.EnviarComando(new CancelarProcessamentoPedidoEstornarEstoqueCommand(message.PedidoId, message.ClienteId));
    }
}